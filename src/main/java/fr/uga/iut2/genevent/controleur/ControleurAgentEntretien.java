...
public class ControleurAgentEntretien {
    ...
    /**
     * Crée un nouvel agent d'entretien et l'ajoute à la liste des agents
     * d'entretien de cet événement.
     * 
    ...
    /**
     * Récupère un agent d'entretien à partir de son nom, prénom, adresse email et
     * numéro de téléphone.
     * 
     ...
     * @return L'agent d'entretien correspondant aux attributs donnés en paramètres
    ...
    /**
     * Retire de la liste des agents d'entretien de cet événement l'agent
     * d'entretien donné en paramètre.
     * 
     ...
     * @throws Exception              Si l'événement est nul.
     * @throws MauvaisChampsException Si le nouveau nom rend l'agent d'entretien
     *                                identique à un autre agent d'entretien.
     */
    public void modifierNomAgentEntretien(AgentEntretien agentEntretien, String nom) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "Le nom de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }
     ...
     * @throws Exception              Si l'événement est nul.
     * @throws MauvaisChampsException Si le nouveau prénom rend l'agent d'entretien
     *                                identique à un autre agent d'entretien.
     */
    public void modifierPrenomAgentEntretien(AgentEntretien agentEntretien, String prenom) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "Le prénom de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }

    /**
     * Modifie l'adresse email de l'agent d'entretien donnée en paramètre.
     * 
     * @param agentEntretien L'agent d'entretien dont l'adresse email doit être
     *                       modifié
     * @param email          Nouvelle adresse email
     * @throws Exception              Si l'événement est nul.
     * @throws MauvaisChampsException Si la nouvelle adresse email rend l'agent
     *                                d'entretien identique à un autre agent
     *                                d'entretien.
     */
    public void modifierEmailAgentEntretien(AgentEntretien agentEntretien, String email) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "L'email de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }
    ...
    public void modifierTelephoneAgentEntretien(AgentEntretien agentEntretien, String telephone) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "Le numéro de téléphone de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }

    /**
     * Modifie l'heure de début d'activité de l'agent d'entretien donné en
     * paramètre.
     * 
     * @param agentEntretien L'agent d'entretien dont l'heure de début d'activité
     *                       doit être modifiée
    ...
    public void modifierHeureDebutAgentEntretien(AgentEntretien agentEntretien, int heureDebut) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "L'heure de début de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }

    /**
     * Modifie l'heure de fin d'activité de l'agent d'entretien donné en paramètre.
     * 
     * @param agentEntretien L'agent d'entretien dont l'heure de fin d'activité doit
     *                       être modifiée
    ...
    public void modifierHeureFinAgentEntretien(AgentEntretien agentEntretien, int heureFin) throws Exception {
        if (evenement != null) {
            ...
            throw new Exception(
                    "L'heure de fin de l'agent d'entretien ne peut être modifié car l'événement du contrôleur est nul");
    }
